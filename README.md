...
* Create personal env file with DB info and Google Books API key.
* Copy and paste the schema file into a query file in MySQL workbench to create and load up the database.
